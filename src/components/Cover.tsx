...
const Cover: FC<CoverProps> = ({ }) => {
    return (
        <div className="flex rounded-2xl w-full bg-[url('/images/cover.jpeg')] bg-no-repeat bg-cover overflow-hidden">
            <div className="flex justify-center md:rounded-2xl overflow-hidden md:px-10 py-5 bg-blur backdrop-filter backdrop-blur-md w-full gap-2 md:gap-10">
                ...
                <div className="flex md:flex-1 flex-col justify-center gap-4">
                    <div className="flex justify-between items-center gap-5 ">
                        ...
                        >
                            <Button variant="primary" className='animate-fade-in-right' sizes={'medium'}>
                                <Instagram />
